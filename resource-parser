/** 
☑️ 资源解析器 ©𝐒𝐡𝐚𝐰𝐧  ⟦2020-10-15 17:59⟧
----------------------------------------------------------
...
const subinfo_link1 = { "open-url": link1, "media-url": "" } // server sub-info link(fake-nodes)
const rwrite_link = { "open-url": link1, "media-url": "" } // rewrite filter link
const rwhost_link = { "open-url": link1, "media-url": "" } // hostname filter link
const rule_link = { "open-url": link1, "media-url": "" } // rule filter link
const nan_link = { "open-url": link1, "media-url": qxpng } // nan error link
const bug_link = { "open-url": "https://t.me/Shawn_KOP_bot", "media-url": "" } // bug link
const sub_link = { "open-url": link1, "media-url": "" } // server link
